...
public class SecurityUtil {
  ...
  // 인증코드 반환하기 (이메일 인증시 받을 인증코드)
  public String getRandomString(int count, boolean letters, int numbers) {
  ...
  /*
    ...
    2. 암호화는 가능하지만 복호화는 불가능한 알고리즘이다. (암호화 시키고나면 원래값은 알아낼 수 없다.)
  ...
  public String getSha256(String str) {
    ...
    try {
      ...
      messageDigest.update(str.getBytes());   // 바이트배열로 바꿔준다.
