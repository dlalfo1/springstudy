...
<body>
	...
	<div>
		...
		<!-- enctype="multipart/form-data" 이 속성을 넣어줘야 파일첨부가 가능하다. -->
		<form method="post" enctype="multipart/form-data" action="${contextPath}/upload/add.do"> 
			...
			<div>
				...
				<input type="file" id="files" name="files" multiple="multiple" onchange="fnFileCheck(this)"> <!-- multiple : 다중첨부를 가능하게 해주는 속성 -->
				<div id="fileList">첨부 파일의 목록이 이곳에 표시됩니다.</div> <!-- $('#fileList').empty();에 의해서 주석처럼 작동한다.  -->
			</div>
			<div>
				<button>작성완료</button>
